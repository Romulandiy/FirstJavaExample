 ...
 * 1) Given sluychaynoe three-digit number, to withdraw hundreds individually, tens, units
 in RUS: 1) Дано слуйчайное трехзначное число, вывести отдельно сотни, десятки, единицы
...
public class Probatask1 {
    public static void main(String[] args)
    {
        ...
        else { System.out.print("Is not a correct entry number: "+ s.nextLine() );
            return; }
        if (n <= 0) { System.out.print("Is not a correct entry number \n It is less than zero: " + n);
            return; }
